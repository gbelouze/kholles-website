...
1.
    ...
    \end{equation*}
2.
    On a donc $F_2 = \sum_{k=1}^n \frac{a_k}{X-k}$
    Et on évalue :
    \begin{align*}
    ...
    \end{equation*}
3.
    Notons $w = e^{\frac{i\pi}{2n}}$, un pôle de $F_3$. Notons $w_0, \ldots, w_{2n-1}$ les racines $2n$-ièmes de l'unité. Il vients que les $\nu_k = ww_k = e^{i\pi \frac{2k+1}{2n}}$ sont les pôles de $F_3$ dans $\C$, puis
    \begin{equation*}
    ...
    \end{equation*}
4.
    On effectue un DL en $0$ de $\frac{x+1}{x+2}$ :
    \begin{align*}
